...
**Key feature (v0.4.4):** `hermes-okf-install` now **auto-configures `~/.hermes/config.yaml`**. The install flow is just **2 steps**:
...
**v0.4.4** — [View on PyPI](https://pypi.org/project/hermes-okf/)
